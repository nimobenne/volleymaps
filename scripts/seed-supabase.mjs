...
const sessions = [
  { venue_id: venueIds['toronto-sandsharks'], title: 'Sandsharks Weekend Open Play', day_of_week: 6, start_time: '10:00', end_time: '14:00', recurring: true, skill_level: 'all', notes: 'Register online first at sandsharks.ca to get schedule details', contact_link: 'https://www.sandsharks.ca/' },
  { venue_id: venueIds['toronto-sandsharks'], title: 'Sandsharks Weekend Open Play', day_of_week: 0, start_time: '10:00', end_time: '14:00', recurring: true, skill_level: 'all', notes: 'Register online first at sandsharks.ca to get schedule details', contact_link: 'https://www.sandsharks.ca/' },
  { venue_id: venueIds['ashbridges-bay-ova'], title: 'OVA Beach League', day_of_week: 6, start_time: '09:00', end_time: '17:00', recurring: true, skill_level: 'all', notes: 'Spring (May–Jun), Summer (Jul–Sep), Fall (Sep) seasons. Mix n Match program available.', contact_link: 'https://www.ashbridgesvolleyball.com/' },
  { venue_id: venueIds['eds-beach-vb-meetup'], title: "Ed's Beach VB Social — Weekend", day_of_week: 6, start_time: '09:00', end_time: '12:00', recurring: true, skill_level: 'all', notes: '$5 CAD cash per event. RSVP on Meetup required. 5 divisions from Rec to Advanced.', contact_link: 'https://www.meetup.com/beach-vball/' },
  { venue_id: venueIds['eds-beach-vb-meetup'], title: "Ed's Beach VB Social — Weekend", day_of_week: 0, start_time: '09:00', end_time: '12:00', recurring: true, skill_level: 'all', notes: '$5 CAD cash per event. RSVP on Meetup required. 5 divisions from Rec to Advanced.', contact_link: 'https://www.meetup.com/beach-vball/' },
  { venue_id: venueIds['junction-pickup-volleyball'], title: 'Junction Sunday Pickup', day_of_week: 0, start_time: '10:30', end_time: '13:00', recurring: true, skill_level: 'all', notes: 'Casual grass volleyball. All welcome.', contact_link: 'https://www.meetup.com/junction-pickup-volleyball/' },
  ...
  { venue_id: venueIds['javelin-eastdale'], title: 'Javelin Thursday Drop-In — High Int', day_of_week: 4, start_time: '18:00', end_time: '20:00', recurring: true, skill_level: 'intermediate', notes: '$10.00 per session. 18+. Cancel 4hr before via Javelin app.', contact_link: 'https://www.javelinsportsinc.com/volleyball-dropin/downtown-toronto' },
  { venue_id: venueIds['javelin-canoe-landing'], title: 'Javelin Friday Drop-In — High Rec', day_of_week: 5, start_time: '18:30', end_time: '21:30', recurring: true, skill_level: 'intermediate', notes: '$14.69 per session. 18+. Cancel 4hr before via Javelin app.', contact_link: 'https://www.javelinsportsinc.com/volleyball-dropin/downtown-toronto' },
  ...
  { venue_id: venueIds['javelin-pakmen'], title: 'Pakmen Monday Drop-In', day_of_week: 1, start_time: '20:00', end_time: '22:00', recurring: true, skill_level: 'intermediate', notes: '$10.50–$12.29 per session. 18+. Book via Javelin app.', contact_link: 'https://www.javelinsportsinc.com/volleyball-dropin/toronto' },
  { venue_id: venueIds['javelin-pakmen'], title: 'Pakmen Thursday Drop-In', day_of_week: 4, start_time: '22:00', end_time: '23:59', recurring: true, skill_level: 'competitive', notes: '$10.50–$12.29 per session. 18+. Book via Javelin app.', contact_link: 'https://www.javelinsportsinc.com/volleyball-dropin/toronto' },
  { venue_id: venueIds['javelin-pakmen'], title: 'Pakmen Friday Drop-In', day_of_week: 5, start_time: '18:00', end_time: '21:00', recurring: true, skill_level: 'intermediate', notes: '$10.50–$12.29 per session. 18+. Book via Javelin app.', contact_link: 'https://www.javelinsportsinc.com/volleyball-dropin/toronto' },
  { venue_id: venueIds['javelin-pakmen'], title: 'Pakmen Saturday Drop-In', day_of_week: 6, start_time: '18:00', end_time: '21:00', recurring: true, skill_level: 'all', notes: '$10.50–$12.29 per session. 18+. Book via Javelin app.', contact_link: 'https://www.javelinsportsinc.com/volleyball-dropin/toronto' },
]
